          ...
          <div className="flex flex-col gap-2">
            {logs.map((log) => (
              ...
              >
                ...
                {selected === log.id && log.detected_objects && log.detected_objects.length > 0 && (
                  <div
                    className={`border-t px-4 py-3 flex flex-wrap gap-1.5 ${
                      isDark ? 'border-slate-700/60 bg-slate-900/40' : 'border-slate-300 bg-slate-200/40'
                    }`}
                  >
                    {log.detected_objects.map((obj, i) => (
                      <span
                        key={i}
