    ...
    <div className="flex flex-col gap-6">
      ...
      {!active ? (
        <button
          ...
          className={`flex items-center justify-center gap-2 px-6 py-3 rounded-xl text-white font-semibold transition-all duration-200 shadow-lg disabled:opacity-60 disabled:cursor-not-allowed w-full ${
            isDark
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className={`px-4 py-3 rounded-xl border transition-colors disabled:opacity-40 disabled:cursor-not-allowed ${
              isDark
      ...
      {/* Detection Stats */}
      {detections.length > 0 && active && (
        <div
          className={`flex items-center justify-between px-4 py-3 rounded-xl border ${
            isDark ? 'border-blue-500/30 bg-blue-950/20' : 'border-blue-300 bg-blue-50'
          }`}
        >
